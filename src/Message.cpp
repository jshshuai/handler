...
Message::Message(int what, int arg1, string str):Message(what, arg1, str, 0){}
Message::Message(int what, int arg1, string str, long uptimeMillis):m_what(what),m_arg1(arg1),m_str(str){
    when = std::chrono::system_clock::now() + std::chrono::milliseconds(uptimeMillis);
    task = nullptr;
}
